...
export default function HairViewer3D({ 
    ...
    return (
        <div className="flex flex-col h-full">
            ...
            <div className="flex-1 bg-[#0a0a0b] rounded-2xl overflow-hidden">
                <Canvas
            ...
            {isFullSet && availableForms.length > 1 && (
                <div className="flex items-center justify-center gap-6 mt-6">
                    <button
                        ...
                        className="bg-white/5 border border-white/10 rounded-full text-white hover:bg-white/10 transition-all p-2"
                    >
