...
export default function FilterDropdown({ label, options, selectedId, onSelect }: FilterDropdownProps) {
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            {isOpen && (
                <div className="absolute z-50 mt-2 w-full min-w-[180px] bg-surface border border-glass-strong rounded-2xl overflow-hidden shadow-dropdown animate-in fade-in zoom-in duration-200">
