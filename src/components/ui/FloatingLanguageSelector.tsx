...
export function FloatingLanguageSelector({ isOpen }: FloatingLanguageSelectorProps) {
    const flagClass = "w-10 h-10 rounded-full overflow-hidden hover:scale-105 transition-all cursor-pointer border border-transparent hover:border-foreground/40 shadow-sm shrink-0 hover:ring-4 hover:ring-foreground/10";
